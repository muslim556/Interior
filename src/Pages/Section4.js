...
export function Section4() {
  ...
  return (
    <>
      <section id="sec2" className="sec4" style={{
        height: "auto"
      }}>
        ...
        <div id="sec2_btns_container">
          <p id="special">Top Special Product</p>
          <div id="sec4_btn">
            <button id="sec4_button">See More Product</button>
          </div>
        </div>
        <div id="sec2_cards_container" className="sec4_container">
          {Products.map((item) => {
            return (
